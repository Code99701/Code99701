...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:06b6d4,100:0e7490&height=140&section=header&text=Arnav%20Mahajan&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=42&desc=CS%20Student%20%C2%B7%20Builder%20%C2%B7%20ML%20Enthusiast&descSize=15&descAlignY=65&descColor=e0f7fa" width="100%"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=19&pause=1000&color=06b6d4&center=true&vCenter=true&width=600&lines=Learning+in+public;Turning+coursework+into+projects;Exploring+AI+and+software)](https://git.io/typing-svg)
...
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=flat-square&logo=leetcode&logoColor=black)](https://leetcode.com/u/VXBBbYkQprs/)
...
- ⌖ **Location** · India
- ⌗ **Focus** · DSA & ML Enthusiast
- ◎ **Education** · Madhav Institute Of Technology and Science
- ⟳ **Learning** · DSA, ML, Web Dev, and Open Source
...
|---|---|---|
| [currency-converter](https://github.com/Code99701/currency-converter-using-api-data) | Real-time currency conversion via live exchange rate APIs | `Python` `API` |
| [IPL Win Predictor](https://github.com/Code99701/macro-project) | ML model predicting match outcomes from historical IPL data | `Python` `ML` `Flask` |
| [DataDNA-AI](https://github.com/Code99701/DataDNA-AI) | AI-powered data analysis & visualization platform | `HTML` `CSS` `JS` `AI` |
| [DSA Questions](https://github.com/Code99701/leetcode-solutions) | Personal LeetCode vault — daily problem solving | `C++` `Python` |
...
<img src="https://skillicons.dev/icons?i=python,js,html,css,cpp,cs&theme=dark" alt="Languages"/>
...
<img src="https://skillicons.dev/icons?i=nodejs,express,fastapi,flask,mysql,supabase&theme=dark" alt="Backend & Databases"/>

**DevOps & Tools**

<img src="https://skillicons.dev/icons?i=git,vscode&theme=dark" alt="DevOps"/>

**AI / ML**

<img src="https://skillicons.dev/icons?i=tensorflow,pytorch&theme=dark" alt="TF PyTorch"/>
...
<img src="https://github-profile-trophy.vercel.app/?username=Code99701&theme=tokyonight&column=6&no-frame=true&margin-w=8" alt="Arnav Mahajan trophies"/>
